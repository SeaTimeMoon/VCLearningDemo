...
void CChartAxis::UndoZoom( double zoomMin,double zoomMax )
{
	SetMinMax(zoomMin,zoomMax);
...
void CChartAxis::SaveAxisInfoBeforeZoom()
{
	AxisPos apos;
	apos.minValue=m_MinValue;
	apos.maxValue=m_MaxValue;
	m_StackStandardAxisPos.push(apos);
}

bool CChartAxis::IsStandardAxisStackEmpty()
{
	bool isEmpty=m_StackStandardAxisPos.empty();
	return isEmpty;
